...
const es: Locale = {
  ...
  t: {
    ...
    metaDesc: '{name} en la guitarra: {notes}. Mapa interactivo del mástil, acordes diatónicos y un drone gratis para improvisar — Modal Runs te escucha por el micrófono e ilumina lo que tocas.',
    ...
    indexDesc: 'Mapas del mástil para los siete modos en las doce tonalidades: notas, acordes diatónicos y un drone gratis para improvisar. Modal Runs te escucha por el micrófono mientras practicas.',
...
const fr: Locale = {
  ...
  t: {
    ...
    metaDesc: '{name} à la guitare : {notes}. Schéma interactif du manche, accords diatoniques et un drone gratuit pour improviser — Modal Runs t’écoute au micro et illumine ce que tu joues.',
    ...
    indexDesc: 'Schémas du manche pour les sept modes dans les douze tonalités : notes, accords diatoniques et un drone gratuit pour improviser. Modal Runs t’écoute au micro pendant que tu pratiques.',
...
const it: Locale = {
  ...
  t: {
    ...
    metaDesc: '{name} alla chitarra: {notes}. Mappa interattiva della tastiera, accordi diatonici e un drone gratis per improvvisare — Modal Runs ti ascolta dal microfono e illumina quello che suoni.',
    ...
    indexDesc: 'Mappe della tastiera per i sette modi nelle dodici tonalità: note, accordi diatonici e un drone gratis per improvvisare. Modal Runs ti ascolta dal microfono mentre ti eserciti.',
...
const pt: Locale = {
  ...
  t: {
    ...
    metaDesc: '{name} na guitarra: {notes}. Mapa interativo do braço, acordes diatônicos e um drone grátis para improvisar — o Modal Runs te escuta pelo microfone e ilumina o que você toca.',
    h1: '{name} na guitarra',
    ...
    indexDesc: 'Mapas do braço para os sete modos nos doze tons: notas, acordes diatônicos e um drone grátis para improvisar. O Modal Runs te escuta pelo microfone enquanto você pratica.',
