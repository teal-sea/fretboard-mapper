...
const es: Locale = {
  ...
  t: {
    ...
    title: 'Modo {name} en la guitarra — Escala, acordes y mapa del mástil | Modal Runs',
    ...
    indexTitle: 'Modos de guitarra en todas las tonalidades — Fórmulas, notas y mapas del mástil | Modal Runs',
    indexDesc: 'Mapas del mástil para los siete modos (escalas modales) en las doce tonalidades: la fórmula y las notas de cada modo, acordes diatónicos y un drone gratis para improvisar. Un entrenamiento auditivo real — Modal Runs te escucha por el micrófono mientras practicas.',
    ...
    footerTag: 'Modal Runs — aprende el diapasón tocándolo. Gratis.',
    homeTitle: 'Modal Runs — Aprende el diapasón tocándolo',
    homeDesc: 'Aprende el diapasón tocándolo: mantén un drone en cualquier tonalidad, improvisa, y Modal Runs ilumina cada nota que tocas en el mástil en tiempo real — un entrenamiento auditivo real. Encuentra los modos de oído en vez de memorizarlos. Gratis.',
    homeH1: 'Modal Runs — aprende el diapasón tocándolo',
...
const fr: Locale = {
  ...
  t: {
    ...
    title: 'Mode {name} à la guitare — Gamme, accords et schéma du manche | Modal Runs',
    ...
    indexTitle: 'Les modes à la guitare dans toutes les tonalités — Formules, notes et schémas du manche | Modal Runs',
    indexDesc: 'Envie de trouver une gamme ou un mode ? Cartographie du manche pour les sept modes dans les douze tonalités : la formule et les notes de chaque mode, accords diatoniques et un drone gratuit pour improviser — un vrai entraînement auditif, à l’oreille. Modal Runs t’écoute au micro pendant que tu pratiques.',
    ...
    footerTag: 'Modal Runs — apprends le manche en le jouant. Gratuit.',
    homeTitle: 'Modal Runs — Apprends le manche en le jouant',
    homeDesc: 'Apprends le manche en le jouant : garde un drone dans n’importe quelle tonalité, improvise, et Modal Runs illumine les notes du manche de guitare que tu joues en temps réel — un vrai entraînement auditif, à l’oreille. Trouve les modes à l’oreille plutôt que de les mémoriser. Gratuit.',
    homeH1: 'Modal Runs — apprends le manche en le jouant',
...
const it: Locale = {
  ...
  t: {
    ...
    title: 'Modo {name} alla chitarra — Scala, accordi e mappa della tastiera | Modal Runs',
    ...
    indexTitle: 'I modi della chitarra in tutte le tonalità — Formule, note e mappe della tastiera | Modal Runs',
    indexDesc: 'Mappe della tastiera (il manico) per i sette modi nelle dodici tonalità: la formula e le note di ogni modo, accordi diatonici e un drone gratis per improvvisare. Un vero allenamento dell’orecchio — Modal Runs ti ascolta dal microfono mentre ti eserciti.',
    ...
    footerTag: 'Modal Runs — impara la tastiera suonandola. Gratis.',
    homeTitle: 'Modal Runs — Impara la tastiera suonandola',
    homeDesc: 'Impara la tastiera suonandola: mantieni un drone in qualsiasi tonalità, improvvisa, e Modal Runs illumina ogni nota che suoni sul manico in tempo reale — un vero allenamento dell’orecchio. Trova i modi a orecchio invece di memorizzarli. Gratis.',
    homeH1: 'Modal Runs — impara la tastiera suonandola',
...
const pt: Locale = {
  ...
  t: {
    ...
    title: 'Modo {name} no violão e na guitarra — Escala, acordes e mapa do braço | Modal Runs',
    ...
    indexTitle: 'Modos de guitarra em todos os tons — Fórmulas, notas e mapas do braço | Modal Runs',
    indexDesc: 'Os sete modos gregos da escala maior, mapeados no braço nos doze tons — use como identificador de escalas e modos: a fórmula e as notas de cada modo, acordes diatônicos e um drone grátis para improvisar. O Modal Runs te escuta pelo microfone enquanto você pratica.',
    ...
    footerTag: 'Modal Runs — aprenda o braço tocando. Grátis.',
    homeTitle: 'Modal Runs — Aprenda o braço tocando',
    homeDesc: 'Aprenda o braço tocando: mantenha um drone em qualquer tom, improvise, e o Modal Runs ilumina cada nota no braço que você toca em tempo real — as notas no braço, o campo harmônico, tudo mapeado. Encontre os modos gregos de ouvido em vez de decorá-los. Grátis.',
    homeH1: 'Modal Runs — aprenda o braço tocando',
