...
export const vi: Locale = {
  ...
  t: {
    ...
    title: '{name} trên guitar — Nốt, sơ đồ cần đàn và drone | Modal Runs',
    ...
    indexTitle: 'Các mode guitar ở mọi giọng — Sơ đồ cần đàn, nốt và drone | Modal Runs',
    indexDesc: 'Sơ đồ cần đàn cho bảy mode ở cả mười hai giọng: nốt, hợp âm diatonic và một drone miễn phí để ngẫu hứng. Luyện tai thật sự — Modal Runs nghe bạn qua micro trong lúc bạn tập.',
    ...
    footerApp: 'Mở app',
    footerTag: 'Modal Runs — luyện guitar miễn phí, biết lắng nghe bạn.',
    homeTitle: 'Modal Runs — Nghe bạn trong lúc bạn chơi',
    homeDesc: 'Một sơ đồ cần đàn tương tác biết lắng nghe: giữ một drone ở bất kỳ giọng nào, ngẫu hứng, và Modal Runs làm sáng từng nốt bạn chơi trên cần đàn theo thời gian thực — luyện tai thật sự. Tìm ra các mode bằng tai thay vì học thuộc. Miễn phí.',
    homeH1: 'Modal Runs — nghe bạn trong lúc bạn chơi',
