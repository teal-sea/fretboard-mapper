...
export const de: Locale = {
  ...
  t: {
    ...
    title: '{name} auf der Gitarre — Töne, Griffbrett-Diagramm und Drone | Modal Runs',
    ...
    indexTitle: 'Gitarren-Modi in allen Tonarten — Griffbrett-Diagramme, Töne und Drones | Modal Runs',
    indexDesc: 'Griffbrett-Diagramme für alle sieben Modi (Kirchentonarten) in allen zwölf Tonarten: Töne, leitereigene Akkorde und ein kostenloser Drone zum Improvisieren. Echtes Gehörtraining — Modal Runs hört dich beim Üben übers Mikrofon.',
    ...
    footerTag: 'Modal Runs — kostenloses Gitarrenüben, das dir zuhört.',
    homeTitle: 'Modal Runs — Hört dir zu, während du spielst',
    homeDesc: 'Ein interaktives Griffbrett-Diagramm, das dir zuhört: Halte einen Drone in jeder Tonart, improvisiere, und Modal Runs lässt jeden Ton, den du spielst, in Echtzeit auf dem Griffbrett aufleuchten — echtes Gehörtraining. Finde die Modi nach Gehör, statt sie auswendig zu lernen. Kostenlos.',
    homeH1: 'Modal Runs — hört dir zu, während du spielst',
