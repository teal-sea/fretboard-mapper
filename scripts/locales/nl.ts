...
export const nl: Locale = {
  ...
  t: {
    ...
    title: '{name} op gitaar — Noten, halsdiagram en drone | Modal Runs',
    ...
    indexTitle: 'Gitaarmodi in alle toonsoorten — Halsdiagrammen, noten en drones | Modal Runs',
    indexDesc: 'Halsdiagrammen voor de zeven modi (kerktoonladders) in alle twaalf toonsoorten: noten, diatonische akkoorden en een gratis drone om over te improviseren. Echte gehoortraining — Modal Runs luistert via je microfoon terwijl je oefent.',
    ...
    footerTag: 'Modal Runs — gratis gitaaroefening die naar je luistert.',
    homeTitle: 'Modal Runs — Hij luistert terwijl je speelt',
    homeDesc: 'Een interactief halsdiagram dat naar je luistert: houd een drone aan in elke toonsoort, improviseer, en Modal Runs licht elke noot die je speelt in realtime op de hals op — echte gehoortraining. Vind de modi op het gehoor in plaats van ze uit je hoofd te leren. Gratis.',
    homeH1: 'Modal Runs — hij luistert terwijl je speelt',
