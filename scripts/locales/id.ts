...
export const id: Locale = {
  ...
  t: {
    ...
    title: 'Mode {name} di gitar — Tangga nada, akor, dan peta fretboard | Modal Runs',
    ...
    indexTitle: 'Mode gitar di semua nada dasar — Rumus, nada, dan peta fretboard | Modal Runs',
    indexDesc: 'Peta fretboard untuk tujuh mode di dua belas nada dasar: rumus dan nada tiap mode, akor diatonis, dan drone gratis untuk improvisasi. Ear training beneran — Modal Runs mendengarkanmu lewat mikrofon saat kamu berlatih.',
    ...
    footerTag: 'Modal Runs — pelajari fretboard dengan memainkannya. Gratis.',
    homeTitle: 'Modal Runs — Pelajari fretboard dengan memainkannya',
    homeDesc: 'Pelajari fretboard dengan memainkannya: tahan drone di nada dasar mana pun, improvisasi, dan Modal Runs menyalakan tiap nada yang kamu mainkan di neck secara real-time — ear training beneran. Temukan mode dengan telinga, bukan hafalan. Gratis.',
    homeH1: 'Modal Runs — pelajari fretboard dengan memainkannya',
