...
export const tr: Locale = {
  ...
  t: {
    ...
    title: 'Gitarda {name} — Notalar, klavye haritası ve dron | Modal Runs',
    ...
    indexTitle: 'Bütün tonlarda gitar modları — Klavye haritaları, notalar ve dronlar | Modal Runs',
    indexDesc: 'Yedi modun on iki tondaki klavye (sap) haritaları: notalar, diyatonik akorlar ve doğaçlama için ücretsiz bir dron. Gerçek bir kulak eğitimi — Modal Runs sen çalışırken seni mikrofondan dinler.',
