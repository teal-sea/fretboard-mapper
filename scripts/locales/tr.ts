...
export const tr: Locale = {
  ...
  t: {
    ...
    footerTag: 'Modal Runs — klavyeyi çalarak öğren. Ücretsiz.',
    homeTitle: 'Modal Runs — Klavyeyi çalarak öğren',
    homeDesc: 'Klavyeyi çalarak öğren: herhangi bir tonda dron tut, doğaçla, Modal Runs çaldığın her notayı sapta gerçek zamanlı aydınlatsın — gerçek bir kulak eğitimi. Modları ezberlemek yerine kulakla bul. Ücretsiz.',
    homeH1: 'Modal Runs — klavyeyi çalarak öğren',
