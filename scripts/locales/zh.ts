...
export const zh: Locale = {
  ...
  t: {
    ...
    title: '吉他上的{name}调式——音阶、和弦与指板图 | Modal Runs',
    ...
    indexTitle: '十二个调的吉他调式大全——音程公式、音名与指板图 | Modal Runs',
    indexDesc: '七个调式（中古调式）在十二个调上的指板图：每个调式的音程公式与音名、顺阶和弦，还有免费持续音供你即兴。真正的练耳训练——你练琴时 Modal Runs 通过麦克风听着你。',
    indexH1: '所有调式，所有调',
    indexLead: '大调音阶的七个调式，在十二个调上铺满指板——附上音名、每个调式内部的和弦，以及一个供你即兴的持续音。选一个调；页面给你指板图，<a href="/">app</a> 在你弹的时候听着你。',
    faqQ: '什么是{name}？',
    footerModes: '所有调式',
    footerApp: '打开 app',
    footerTag: 'Modal Runs——边弹边学指板。免费。',
    homeTitle: 'Modal Runs——边弹边学指板',
    homeDesc: '边弹边学指板：在任意调上开一个持续音，随意即兴，Modal Runs 实时在指板上点亮你弹的每个音——真正的练耳训练。用耳朵找到调式，而不是死记硬背。免费。',
    homeH1: 'Modal Runs——边弹边学指板',
